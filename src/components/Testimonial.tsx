    ...
    <section className="py-24 px-16 bg-[#141414] relative">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-2 fade-up opacity-0 translate-y-8 transition-all duration-700">
        ...
        <blockquote className="font-serif text-2xl md:text-3xl text-white leading-relaxed mb-8">
          Mbalire is an exceptional designer who transformed our brand identity completely. 
          His creative vision and attention to detail brought our brand to life in ways we never imagined.
        </blockquote>
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="text-left">
            <div className="font-serif text-lg font-bold text-white">Sarah Mitchell</div>
            <div className="font-mono text-xs tracking-widest uppercase text-[#888]">Marketing Director, Creative Agency</div>
          </div>
        </div>
      </div>
    </section>
