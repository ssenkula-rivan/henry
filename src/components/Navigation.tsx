...
export default function Navigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-100 flex justify-between items-center px-16 py-8 transition-all duration-300 ${
      ...
      <a 
        href="#contact"
        className="bg-[#8b5cf6] text-black px-8 py-3 font-mono text-xs tracking-widest uppercase font-bold hover:bg-[#7c3aed] hover:-translate-y-0.5 transition-all duration-200 no-underline"
      >
        Hire Me
      </a>
    </nav>
